...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">好厉害啊！游戏城的娃娃机超难抓。</option>
    <option value="o2">游戏城的娃娃机超难抓，我就没抓到过。</option>
    <option value="o3">不行，我受刺激了，从没抓到过的我一定要一雪前耻。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">嫉妒使我丑陋</option>
    <option value="o5">这么多娃娃学长你全给韩野了？</option>
    <option value="o6">好啊好啊，感觉到时候会让现场其他人羡慕嫉妒恨呢~</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">学长很喜欢抓娃娃吗？</option>
    <option value="o8">不过还是忍不住八卦下，韩野要这么多娃娃干什么？</option>
    <option value="o9">不，我一定要自己抓！</option>
  </select>
