...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">哈哈，我哪天不美？</option>
    <option value="o2">恩恩，我下次会注意。</option>
    <option value="o3">很久没有散步了，今天饭后跟你一起散步，很愉快。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">谢谢夸奖。</option>
    <option value="o5">今天深深地体会到美丽冻人的意思了。</option>
    <option value="o6">今天跟你说了很多话，好开心啊</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">穿了西装的你，今天也很不一样。</option>
    <option value="o8">你的外套很温暖，我一点不觉得冷。</option>
    <option value="o9">嗯，我知道啦，放心吧。</option>
  </select>
