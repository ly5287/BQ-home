...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">刚才你从身后出现，真是吓死我了……</option>
    <option value="o2">包括你吗？</option>
    <option value="o3">你是我信任的人。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">我知道你是在吓我，所以没有在意。</option>
    <option value="o5">真的有这么危险吗？</option>
    <option value="o6">谢谢你告诉我这些。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">下次不要这样了，有点吓到我了。</option>
    <option value="o8">会不会想的太严重了，其实并没有到这个地步。</option>
    <option value="o9">知道现实的情况，心里突然很沉重。</option>
  </select>
