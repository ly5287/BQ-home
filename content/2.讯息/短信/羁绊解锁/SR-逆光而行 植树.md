...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">诶你怎么知道！？我正在参与一个很重要的活动呢</option>
    <option value="o2">嗯嗯！我的步数还差一点就够了！</option>
    <option value="o3">好啊，那我可要开始想想这棵我们一起种下的小树苗叫什么名字比较好了！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">嗯！我在竞走呢，最近不是有环保活动嘛，累积运动步数可以亲手种树！</option>
    <option value="o5">对呀，还有两天就截止了，我还一棵树都没养成QAQ！</option>
    <option value="o6">可是你明早还要出任务呢，还是好好休息，等我的好消息吧白警官！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">嗯！我在参加前两天跟你说的那个活动。</option>
    <option value="o8">咦，你还记得呢！天知道我走了两周了还是没种出一棵树QAQ……</option>
    <option value="o9">不用啦，我还从没有独自亲手种下一棵树呢，趁着这次的机会一定要成功！</option>
  </select>
