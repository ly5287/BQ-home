...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">哈哈哈哈，不行了，发出去我就笑死了</option>
    <option value="o2">这是之前的网络流行语，还有配套的表情包呢~</option>
    <option value="o3">下次见面我给你科普吧，其实蛮有趣的。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">你是不是被我吓到了？</option>
    <option value="o5">因为我打算做个流行语的节目，搜集了一些，在找各种人试试反应。</option>
    <option value="o6">有空的时候可以多刷刷微博，看看热门哦。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">这句话是不是很有意思？</option>
    <option value="o8">吓到你了不好意思啊</option>
    <option value="o9">学长可不要被流行淘汰了哦！</option>
  </select>
