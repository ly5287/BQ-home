...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">[[玩家姓名]]：如果今天和你出去的不是我，你也会给别的女孩送花吗？</option>
    <option value="o2">[[玩家姓名]]：你真是个温柔的人，身边的人很幸运呢。</option>
    <option value="o3">[[玩家姓名]]：我在你的心里是特别的吗？</option>
  </select>
  <div id="o1" class="opt-content">
 [[玩家姓名]]：如果今天和你出去的不是我，你也会给别的女孩送花吗？  <br>
   <br>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">[[玩家姓名]]：谢谢你送我的花，收到的时候还吓了一跳了。</option>
    <option value="o5">[[玩家姓名]]：放心吧，我会好好照料它的，毕竟是你送我的东西。</option>
    <option value="o6">[[玩家姓名]]：把它交给你我就放心啦。</option>
  </select>
  <div id="o4" class="opt-content">
 [[玩家姓名]]：谢谢你送我的花，收到的时候还吓了一跳了。  <br>
   <br>
 ...
 [[玩家姓名]]：放心吧，我会好好照料它的，毕竟是你送我的东西。  <br>
   <br>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">[[玩家姓名]]：我已经把花插到花瓶里了，很香哦。</option>
    <option value="o8">[[玩家姓名]]：收到花的女孩很幸运也很幸福喔。</option>
  </select>
  <div id="o7" class="opt-content">
 [[玩家姓名]]：我已经把花插到花瓶里了，很香哦。  <br>
   <br>
