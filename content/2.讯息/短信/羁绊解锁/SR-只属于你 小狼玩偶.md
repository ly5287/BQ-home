...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">谢谢你的创口贴，已经好多啦！</option>
    <option value="o2">嗯？什么问题？关于什么的？</option>
    <option value="o3">它给我的感觉很像你</option>
    <option value="o4">唔…桀骜不驯？书上说，狼的态度很单纯，就是对成功坚定不移地向往。这一点很像你。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o5">稍微还有点疼，不过还好。</option>
    <option value="o6">没想到你也会有好奇的时候啊。</option>
    <option value="o7">说了你别生气，总觉得它跟你长得很像。</option>
    <option value="o8">人都有不同的一面啊，说不定你真的有呆萌的一面呢！</option>
  </select>
