...
<div class="opt-group">  
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">  
    <option value="o1-1">在你眨眼睛的时候拍的。</option>  
    <option value="o1-2">哈哈，是想表扬我的拍照技术吗？</option>  
    <option value="o1-3">在你接电话的时候拍的，不小心带到了你的背影。</option>  
  </select>  
...
<div class="opt-group">  
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">  
    <option value="o2-1">谢谢你的惊喜，不过你怎么知道我想看烟花？</option>  
    <option value="o2-2">烟花很漂亮，不过你怎么知道我想看烟花？</option>  
    <option value="o2-3">没想到你有那么浪漫的一面。</option>  
  </select>  
...
<div class="opt-group">  
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">  
    <option value="o3-1">那是一条很早的朋友圈啊……</option>  
    <option value="o3-2">啊，你要是不提我都忘了……</option>  
    <option value="o3-3">原来是这样啊。</option>  
  </select>  
