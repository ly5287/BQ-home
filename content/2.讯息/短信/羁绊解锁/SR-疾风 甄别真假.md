...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">不用啦，你的批注写得好详细~</option>
    <option value="o2">说起来有点好奇，会有让你也难辨真假的奇异事件吗？</option>
    <option value="o3">对了，你明晚有空吗？还有几个细节想询问你一下。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">稍等一下，还有两份事件报告我汇总一下发给你！</option>
    <option value="o5">不过这样麻烦你，会不会影响你的日常工作？</option>
    <option value="o6">你帮了我这么多，不知道该怎么谢你才好。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">我把最近的奇异事件报告多看两遍，再想一想~</option>
    <option value="o8">感觉你知道得好多~</option>
    <option value="o9">老实说，有些假事件看着还挺好笑的！</option>
  </select>
