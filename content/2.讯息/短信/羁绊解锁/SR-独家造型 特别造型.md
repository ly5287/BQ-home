...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">居然怀疑我……伤心了！</option>
    <option value="o2">我刚刚是说着玩的，不用那么较真啦。</option>
    <option value="o3">反正我是真心喜欢你这个发型！想多看看。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">比真金还真！</option>
    <option value="o5">别那么较真嘛……</option>
    <option value="o6">反正我觉得你这样梳辫子很可爱，每天都想看！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">你变了！居然不相信我。</option>
    <option value="o8">总之！你露出额头超好看der，平时不露出来有点可惜。</option>
  </select>
