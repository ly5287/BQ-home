...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">好呀！正好你还可以给我当现场独家解说~</option>
    <option value="o2">yes，sir！感觉现在就开始有点期待了！</option>
    <option value="o3">你今天晚上有空吗？我们干脆一起去采购好了！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">要加班，可能会到12点多……这样你等太久了</option>
    <option value="o5">知道啦，全听你安排</option>
    <option value="o6">哼哼~回来以后我就准备了比赛专用冰箱，一切都到位~</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">我很担心自己会看不懂……当然如果你不嫌弃给我再一一介绍的话！！</option>
    <option value="o8">没关系啦，你可以在家里等我~</option>
    <option value="o9">不用啦~我有准备冰汽水，小龙虾可以当晚再点！看比赛嘛，还是旁边的人比较重要些</option>
  </select>
