...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1-1">好呀！不过我最近事情超多……今晚恐怕是不行了……</option>
    <option value="o1-2">可能不太方便呢，最近超忙的，累……</option>
    <option value="o1-3">那就脆皮烤鸡吧！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o3-1">其实我最想吃火锅了……可惜不能外卖tut</option>
    <option value="o3-2">那……想吃红烧狮子头！会不会太油腻了QAQ……</option>
  </select>
