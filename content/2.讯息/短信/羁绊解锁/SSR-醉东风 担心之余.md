...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">该睡觉了白大侠！</option>
    <option value="o2">啊啊啊啊忘了吧好丢脸啊鼻子还冒泡了……</option>
    <option value="o3">好啊！那如果你食言了怎么办……</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">我有哭吗？哪有……你记错了！</option>
    <option value="o5">好吧，你要是喜欢，我常常哭给你看！</option>
    <option value="o6">那我们可要拉钩钩哦！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">大晚上还不睡！你在想什么呢！</option>
    <option value="o8">是不是哭得可真情实感了！是！因为我真的被吓到了嘛……</option>
    <option value="o9">嗯！不可以再做让我担心的事，但是如果遇到什么问题，一定要告诉我！</option>
  </select>
