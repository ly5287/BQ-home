...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">哇果然没找错人！</option>
    <option value="o2">白起你到底有多少隐藏技能啊？连这么难得街舞都会，听说街舞练习的时候经常会受伤诶！</option>
    <option value="o3">对了，你怎么突然问这个？</option>
    <option value="o4">被你发现了！想学！……你、你教我吗？！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o5">居然连街舞也会吗！好厉害啊</option>
    <option value="o6">啊？高中的时候吗？我都没见过！听说街舞好难，经常会受伤……</option>
    <option value="o7">下一期我们要拍个街舞相关的节目，想请你当嘉宾！</option>
    <option value="o8">虽然我很想，但是我觉得自己不行……还是看着你帅就好了！</option>
  </select>
