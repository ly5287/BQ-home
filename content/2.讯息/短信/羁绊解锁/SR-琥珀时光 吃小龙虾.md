...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">真没想到这么不起眼的一家店，生意竟然这么好。</option>
    <option value="o2">学长今晚吃尽兴了吗？</option>
    <option value="o3">真的吗？我现在已经开始期待啦！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">其实我好怕你来之前就关门了，因为真的很晚了……</option>
    <option value="o5">我现在依然意犹未尽呢~</option>
    <option value="o6">下次是什么时候？</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">这家店可以载入我的美食红榜了。</option>
    <option value="o8">因为超好吃，所以我今晚吃了好多……</option>
    <option value="o9">真的吗？骗人的是小狗！</option>
  </select>
