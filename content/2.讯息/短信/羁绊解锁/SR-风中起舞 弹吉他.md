...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">吉他是用“弹”这个动词吧……？</option>
    <option value="o2">看到视频里的指弹好帅，有点想学。</option>
    <option value="o3">会很难吗……</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">吉他……</option>
    <option value="o5">教练我要学吉他！</option>
    <option value="o6">怎么办你这么一说我已经有点想打退堂鼓了。</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">我一定可以顺利学会的！</option>
  </select>
