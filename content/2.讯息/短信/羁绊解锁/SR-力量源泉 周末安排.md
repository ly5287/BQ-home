...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o1">听起来白先生是要约我嘛？</option>
    <option value="o2">好呀！听说新开了一家射击馆，要不要去看看？</option>
    <option value="o3">听起来还不错哦！</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o4">还没想好……</option>
    <option value="o5">嗯……不过这周好忙，周末想来一波“懒人活动”！</option>
    <option value="o6">嗯……不过，你怎么会计划这场海滩之行？</option>
  </select>
...
<div class="opt-group">
  <select class="opt-select" style="padding:3px 6px;border-radius:3px;border:1px solid #ccc;">
    <option value="o7">没有呀，准备在家躺两天玩手机！</option>
    <option value="o8">不会又要去训练体能吧……我可以拒绝嘛！</option>
    <option value="o9">唔，和海边相比的话，有点更想去湿地公园呢……</option>
  </select>
